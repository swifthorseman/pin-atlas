...
- [`docs/adr/`](docs/adr/) — architecture decision records (the *why* behind the
  technical choices).
...
under [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/). GeoNames is
credited as the source; this project's code is MIT-licensed (see
[LICENSE](LICENSE)).
